...
//             }
            ...
            // 原 ： f.innerHTML = '<div class="mui-toast-message">' + b + "</div>"
            return  f.classList.add("mui-toast-container"),
                    f.innerHTML =  "undefined" == typeof d.icon ? '<div class="mui-toast-message">' + b + "</div>" : '<div class="mui-toast-message"><img class="custom-toast-icon" src="'+d.icon+'"/>' + b + "</div>",
