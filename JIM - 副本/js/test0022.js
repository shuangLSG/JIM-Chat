$(function () {
    (function (mui, $) {
        ...
        // 发送信息
        document.querySelector('#sendPic2').addEventListener('tap', function () {
        ...
        function sendPicAction(el, data) {
            var file = el;
            ...
            //     }
            // );
            const formData=Util.getFileFormData(file);
            sendPicContent
        }
